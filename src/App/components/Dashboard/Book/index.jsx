...
function Book() {
  ...
  useEffect(() => {
    fetch("http://127.0.0.1:3000/trips", {
      method: "GET",
      headers: {
  ...
  return (
    <div className="h-screen">
      ...
      <div className="grid grid-cols-1 gap2 m-2">
        ...
        <p className="w-full text-black text-2xl p-5 m-2">Nairobi - Kisumu</p>
        <p className="w-full text-black text-2xl p-5 m-2">Nairobi - Eldoret</p>
        <p className="w-full text-black text-2xl p-5 m-2">Nairobi - Nakuru</p>
      </div>
    </div>
  );
}
